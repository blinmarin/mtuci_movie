import { IMovie, IMovieData, IMovieDataSingle } from "@/interfaces/interface";
...
const MovieItem: FC<IMovieDataSingle> = ({ movie }) => {
    ...
    return (
        <div className=''>
            ...
            <div className="flex items-center w-100 h-72 m-5 p-5 space-x-4 bg-yellow-100 rounded-3xl shadow-xl hover:brightness-75 duration-300">
                ...
                {/* {movies.map(movie => <img src={movie.medium_cover_image} alt={movie.title} key={movie.id}/>)} */}
            </div>
        </div>
